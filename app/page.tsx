...
export default function Dashboard() {
  ...
  if (error) {
    return (
      <div className="flex h-screen items-center justify-center" data-testid="error-state">
  ...
  if (!patientData) {
    return (
      <div className="flex h-screen items-center justify-center" data-testid="no-data-state">
